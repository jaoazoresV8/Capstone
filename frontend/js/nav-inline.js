...
(function () {
  ...
  var html =
    ...
    '            <i class="bi bi-person-circle"></i> <span id="nav-user-name">User</span><span id="nav-admin-reset-dot" class="nav-admin-dot d-none" aria-label="Pending password reset requests"></span>' +
    '          </button>' +
